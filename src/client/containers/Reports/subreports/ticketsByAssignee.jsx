      ...
      <TruCard
        ...
        header={
          <div style={{ padding: '10px 15px' }}>
            <h4 style={{ width: '100%', textAlign: 'left', fontSize: '14px', margin: 0 }}>Задачи по ответственным</h4>
          </div>
        }
        ...
        content={
          <div>
            ...
            Выберите начальную и конечную даты, а также группы, которые следует включить в отчет.
            </p>
            ...
            <div className={'padding-15'}>
              <form onSubmit={e => onFormSubmit(e)}>
                <Grid>
                  ...
                  <GridItem width={'1-1'}>
                    <div className='uk-margin-medium-top uk-margin-medium-bottom'>
                      <label htmlFor='priorities'>Ответственный</label>
                      <SingleSelect
                        multiple={true}
                        items={agents}
